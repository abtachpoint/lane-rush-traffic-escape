...
The in-app purchase product IDs are already coded, but you must create/activate matching one-time products in Play Console before prices load from Google Play.
